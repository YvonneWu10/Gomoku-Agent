...
from policy_value_net_withGAP_single import PolicyValueNet, Net
...
class Game(object):
    ...
    def policy_evaluate(self, model_file, n_games=10):
        ...
        best_policy = PolicyValueNet(self.board.width, self.board.height)
...
if __name__ == '__main__':
        ...
        board_height = 9
        n_in_row = 5
        model_file = "GP_padding_model.model"
