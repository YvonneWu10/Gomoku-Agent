...
class Game(object):
    ...
    def policy_evaluate(self, model_file, n_games=10):
        ...
        best_policy = PolicyValueNet(self.board.width, self.board.height) # , use_gpu=False
        best_policy.policy_value_net.load_state_dict(torch.load(model_file)) # , map_location='cpu'
