...
from policy_value_net_pytorch_res1_1 import PolicyValueNet as PolicyValueNetRes
...
class Game(object):
    ...
    def __init__(self, board,pure_mcts_playout_num, **kwargs):
        self.board = board
    ...
    def policy_evaluate(self, model_file, n_games=10):
        ...
        #比较1500轮和200轮的性能
        # best_policy_200 = PolicyValueNetGap(self.board.width,self.board.height)
        # best_policy_200.policy_value_net.load_state_dict(torch.load('loey/goproject/gpoolmodel/best_policy.model'))
        # mcts_player_200 = MCTSPlayer(best_policy_200.policy_value_fn,c_puct=5,n_playout=200)

        best_policy = PolicyValueNetRes(self.board.width,self.board.height)
...
if __name__ == '__main__':
    ...
    board_height = 9
    n_in_row = 5
    model_file = "loey/goproject/res1_1/res_1_model_1500/best_policy__playout 3000__winRation 0.9.model.model"
