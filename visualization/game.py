...
from policy_value_net_withGAP_single_pad import PolicyValueNet as PolicyValueNetGap
...
if __name__ == '__main__':
    ...
    board_height = 9
    n_in_row = 5
    model_file = "gpoolmodel_1500/best_policy.model"
    ...
    # while task.policy_evaluate(model_file, n_games=10) > 0.7:
    #     seed_torch()
